...
TODO
- create good dashboard
- api add prometheus data source
- api import dashboard
- add elastic search data source with geo loc
- add persistence
- add volumes
- expose dashboards from console
- add console welcome screen
- update dasboard to visualize geo location data
- add metabase
- update readme 
- Add fluent validation
- Add request behavior to handle custom exceptions
- Add clean architecture
- Add shop cilents simulations app